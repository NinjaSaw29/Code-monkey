!function(t, e, n) {
    ...
    for (var o = "function" == typeof __nr_require && __nr_require, i = 0; i < n.length; i++)
        r(n[i]);
    return r
}({
    1: [function(t, e, n) {
    ...
    2: [function(t, e, n) {
        function r(t, e, n, r) {
            var o = d(t, e, n);
            return o.stats = a(r, o.stats),
            o
        }
        function o(t, e, n, r, o) {
            var a = d(t, e, n, o);
            return a.metrics = i(r, a.metrics),
            a
        }
        function i(t, e) {
            return e || (e = {
        ...
        function a(t, e) {
            return null == t ? s(e) : e ? (e.c || (e = f(e.t)),
            e.c += 1,
            e.t += t,
            e.sos += t * t,
            t > e.max && (e.max = t),
        ...
        function c(t, e) {
            return e ? (e.c || (e = f(e.t)),
            e.min = Math.min(t.min, e.min),
            e.max = Math.max(t.max, e.max),
            e.t += t.t,
            e.sos += t.sos,
            e.c += t.c,
            e) : t
    ...
    3: [function(t, e, n) {
        ...
        function i(t, e, n) {
            ...
            g.customTransaction = (n || "http://custom.transaction") + e)
        }
        function a(t, e) {
        ...
        function u(t, e, n, r, o, i, a) {
            if (e = window.encodeURIComponent(e),
            x += 1,
            g.info.beacon) {
        ...
        function a(t, e) {
            ...
            return u(t, function(t, i) {
                ...
                if ("string" == typeof i)
                    ...
                    for (n += 9,
                    s = 0; s < i.length && (a = o(c(i[s])),
                    n += a.length,
                    !("undefined" != typeof e && n >= e)); s++)
                        u.push(a);
                    r += "&" + t + "=%5B" + u.join(",") + "%5D"
                }
            }),
    ...
    9: [function(t, e, n) {
        ...
        var o = t(10)
          , i = t(23);
        e.exports = r,
        r.prototype.startTimer = function(t, e) {
            this.interval = t,
            this.started = !0,
            ...
            if (this.opts.getPayload) {
                ...
                if (s) {
                    ...
                    for (var u = 0; u < s.length; u++)
                        o.send(this.endpoint, this.loader, s[u], t, r, e)
                }
            } else
                o.sendX(this.endpoint, this.loader, t, e);
    ...
    10: [function(t, e, n) {
            ...
            if (t.info.beacon) {
                ...
                if (n) {
                    var r = "1"
                      , o = [m(t)];
                    if (o.push(n),
                    o.push(w.param("tt", t.info.ttGuid)),
                    o.push(w.param("us", t.info.user)),
                    o.push(w.param("ac", t.info.account)),
                    o.push(w.param("pr", t.info.product)),
                    o.push(w.param("af", g(t.features, function(t) {
                        return t
                    }).join(","))),
                    ...
                    if (window.performance && window.performance.getEntriesByType) {
                        ...
                        a && a.length > 0 && a.forEach(function(t) {
                            !t.startTime || t.startTime <= 0 || ("first-paint" === t.name ? o.push(w.param("fp", String(Math.floor(t.startTime)))) : "first-contentful-paint" === t.name && o.push(w.param("fcp", String(Math.floor(t.startTime)))),
                            I(t.name, Math.floor(t.startTime)))
                        })
                    }
                    o.push(w.param("xx", t.info.extra)),
                    o.push(w.param("ua", t.info.userAttributes)),
                    o.push(w.param("at", t.info.atts));
        ...
        function c(t, e, n, r, o, i) {
            ...
            n.qs && (a += w.obj(n.qs, e.maxBytes)),
            o || (o = f(t, r));
            var s, u = o.method, c = o.useBody, d = a;
            ...
            if (i && u === x.xhr) {
                ...
                p.addEventListener("load", function() {
                    ...
                    t.delay = O) : 408 !== this.status && 500 !== this.status && 503 !== this.status || (t.retry = !0),
                    r.needResponse && (t.responseText = this.responseText),
                    i(t)
                }, P(!1))
            }
            return l || u !== x.beacon || (u = x.img,
            l = u(a + w.obj(n.body, e.maxBytes))),
            l
        }
        function f(t, e) {
            e = e || {};
        ...
        function m(t) {
            var e = !0;
            return "init"in NREUM && "privacy"in NREUM.init && (e = NREUM.init.privacy.cookies_enabled),
            ["?a=" + t.info.applicationID, w.param("sa", t.info.sa ? "" + t.info.sa : ""), w.param("v", C), d(t), w.param("ct", t.customTransaction), "&rst=" + t.now(), "&ck=" + (e ? "1" : "0"), w.param("ref", A(j.getLocation())), w.param("ptid", t.ptid ? "" + t.ptid : "")].join("")
        }
        function h() {
            var t = {}
              , e = !1;
    ...
    12: [function(t, e, n) {
        ...
        var o = t(21)
          ...
          , m = t(41);
        t(3),
        t(24).init(c, l.getConfiguration("page_view_timing"));
        ...
        setTimeout(function() {
            for (var t = 0; t < p.length; t++)
                m.recordSupportability("Framework/" + p[t] + "/Detected")
        }, 0)
    }
    , {}],
    13: [function(t, e, n) {
    ...
    15: [function(t, e, n) {
        function r(t, e) {
            ...
            i(t[f + s], n, e, "dne"),
            i(t["c" + d + a], n, e, "c"),
            i(t["secureC" + d + "ion" + a], n, e, "s"),
            i(t["c" + d + s], n, e, "ce"),
            i(t[l + a], n, e, "rq"),
            i(t[p + a], n, e, "rp"),
            i(t[p + s], n, e, "rpe"),
            i(t.domLoading, n, e, "dl"),
            i(t.domInteractive, n, e, "di"),
            i(t[h + a], n, e, "ds"),
            i(t[h + s], n, e, "de"),
            i(t.domComplete, n, e, "dc"),
            i(t[m + a], n, e, "l"),
            i(t[m + s], n, e, "le"),
            e
        }
        function o(t, e) {
            return i(t.type, 0, e, "ty"),
            i(t.redirectCount, 0, e, "rc"),
            e
        }
        function i(t, e, n, r) {
            var o;
            "number" == typeof t && t > 0 && (o = Math.round(t - e),
            n[r] = o),
            v.push(o)
        }
        var a = "Start"
    ...
    20: [function(t, e, n) {
        ...
        function o() {
            if (!(c && c < 9)) {
                var n = t(45);
                return n.exists ? (e.exports.navCookie = !1,
        ...
        function i() {
            for (var t = document.cookie.split(" "), e = 0; e < t.length; e++)
                if (0 === t[e].indexOf("NREUM=")) {
                    for (var n, r, o, i, s = t[e].substring("NREUM=".length).split("&"), u = 0; u < s.length; u++)
                        0 === s[u].indexOf("s=") ? o = s[u].substring(2) : 0 === s[u].indexOf("p=") ? (r = s[u].substring(2),
                        ";" === r.charAt(r.length - 1) && (r = r.substr(0, r.length - 1))) : 0 === s[u].indexOf("r=") && (n = s[u].substring(2),
                        ";" === n.charAt(n.length - 1) && (n = n.substr(0, n.length - 1)));
                    if (n) {
                        var c = a(document.referrer);
                        i = c == n,
                        i || (i = a(document.location.href) == n && c == r)
                    }
                    if (i && o) {
    ...
    21: [function(t, e, n) {
        function r(t, e) {
            "undefined" == typeof e && (e = a() + a.offset),
            s[t] = e
        }
        function o(t, e, n) {
            var r = s[e]
        ...
        function i(t, e) {
            ...
            case "object":
                ...
                if (n instanceof window.Array || "[object Array]" === Object.prototype.toString.apply(n)) {
                    for (var s = n.length, u = 0; u < s; u += 1)
                        r[u] = i(u, n) || "null";
    ...
    24: [function(t, e, n) {
        ...
        function o() {
            if (!O && null !== q) {
                ...
                n && (n["net-type"] && (r["net-type"] = n["net-type"]),
                n["net-etype"] && (r["net-etype"] = n["net-etype"]),
                n["net-rtt"] && (r["net-rtt"] = n["net-rtt"]),
                n["net-dlink"] && (r["net-dlink"] = n["net-dlink"])),
                t.url && (r.elUrl = C(t.url)),
        ...
        function h(t) {
            for (var e = w(), n = "bel.6;", r = 0; r < t.length; r++) {
                ...
                p(o);
                var i = b(o.attrs, e);
                i && i.length > 0 && (n += y(i.length) + ";" + i.join(";")),
                r + 1 < t.length && (n += ";")
            }
            return n
        }
    ...
    25: [function(t, e, n) {
        function r(t) {
            var e = i(t);
            !o || navigator.sendBeacon ? a("pagehide", e) : a("beforeunload", e),
            a("unload", e)
        }
        var o = t(39)
          , i = t(19)
    ...
    27: [function(t, e, n) {
        ...
        function i(t, e) {
            var n = a(e);
            return n ? (f(n.func) ? t.wrapperSeen = !0 : t.stackLines.push(e),
            t.wrapperSeen || t.frames.push(n),
            t) : (t.stackLines.push(e),
            t)
        }
        function a(t) {
            var e = t.match(v);
            return e || (e = t.match(h)),
            e ? {
                url: e[2],
    ...
    29: [function(t, e, n) {
        function r(t) {
            ...
            var n = {
              ...
              , r = S(g.releaseIds);
            return "{}" !== r && (n.qs.ri = r),
            e && e.err && e.err.length && !N && (n.qs.pve = "1",
            N = !0),
            n
        }
        function o(t) {
        ...
        function c(t) {
            for (var e = m(g.origin), n = 0; n < t.frames.length; n++) {
                var r = t.frames[n]
                  ...
                  , i = s(o, e);
                i && i !== r.url && (r.url = i,
                t.stackString = t.stackString.split(o).join(i))
            }
            return t
        }
        function f(t, e, n, r) {
            ...
            n || !g.onerror || !g.onerror(t)) {
                ...
                w[f.stackHash] ? f.browser_stack_hash = v(a.stackString) : (w[f.stackHash] = !0,
                f.stack_trace = R(a.stackString)),
                ...
                if (j("errorAgg", [p, d, f, m]),
                null != f._interactionId)
                    M[f._interactionId] = M[f._interactionId] || [],
                    M[f._interactionId].push([p, d, f, m, x, r]);
                else {
                    var y = {}
        ...
        var d, l = t(2), p = t(26), m = t(5), h = t(27), v = t(30), g = t("loader"), y = t("ee"), w = {}, b = {}, x = t(17), T = t(10), E = t(9), S = t(22), j = t("handle"), k = t("ee"), A = t(43), C = t(37), R = t(28).truncateSize, M = {};
        if (t(20),
        g.features.err) {
            var N = !1
    ...
    31: [function(t, e, n) {
        ...
        function o(t) {
            t && t.sent && t.retry && u && (x = x.concat(u),
            u = null)
        }
        function i(t, e, n) {
            function r(t, e) {
            ...
            if (!(x.length >= b)) {
                var o, i, a = {};
                "undefined" != typeof window && window.document && window.document.documentElement && (o = window.document.documentElement.clientWidth,
        ...
        var s, u, c = t("ee"), f = t("loader"), d = t(43), l = t(22), p = t(17), m = t(10), h = t(9), v = t(5), g = t(37), y = 240, w = g.getConfiguration("ins.harvestTimeSeconds") || 30, b = y * w / 60, x = [], T = f.info.jsAttributes = {};
        document.referrer && (s = v(document.referrer)),
        p("api-setCustomAttribute", a, "api"),
        c.on("feat-ins", function() {
            p("api-addPageAction", i),
            m.on("ins", r);
            var t = new h(f,"ins",{
                onFinished: o
            });
    ...
    32: [function(t, e, n) {
        ...
        function o(t, e) {
            ...
            for (n in t)
                r = t[n],
                "number" == typeof r && r > 0 && r < i && (o = e ? t[n] : t[n] - E.offset,
                p({
                    n: n,
                    s: o,
                    e: o,
        ...
        function u(t, e) {
            ...
            if (t && t instanceof XMLHttpRequest) {
                ...
                t && "string" == typeof t.tagName && (n = t.tagName.toLowerCase(),
                t.id && (n += "#" + t.id),
                t.className && (n += "." + M(t.classList).join(".")));
            return "unknown" === n && ("string" == typeof e ? n = e : e === document ? n = "document" : e === window ? n = "window" : e instanceof FileReader && (n = "FileReader")),
            n
        }
        function c(t, e, n) {
            var r = {
        ...
        function g(t) {
            ...
            return function(o, i) {
                ...
                a || (a = o[i.o] = []);
                var s = r[i.o];
                return "scrolling" !== t || x(i) ? s && i.s - s.s < n && s.e > i.s - e ? s.e = i.e : (r[i.o] = i,
                a.push(i)) : (r[i.o] = null,
                i.n = "scroll",
                a.push(i)),
                o
        ...
        if (j.xhrUsable && E.xhrWrappable) {
            ...
            E.features.stn) {
                z.on("feat-stn", function() {
                    function t(t) {
                        t.sent && t.responseText && !U && (U = t.responseText,
                        E.ptid = U,
                        n.startTimer(F)),
                        t.sent && t.retry && B && (A(B, function(t, e) {
                            m(t, e)
                        }),
                        B = null)
                    }
    ...
    34: [function(t, e, n) {
        function r(t) {
            ...
            for (var e = 0; e < s.length; e++) {
                ...
                if ("*" === n.hostname)
                    return !1;
                if (i(n.hostname, t.hostname) && a(n.pathname, t.pathname))
                    return !1
            }
            return !0
        }
    ...
    35: [function(t, e, n) {
        ...
        function o(t, e, n, r, o) {
            e.time = n;
            var i;
            if (i = v(t.cat ? [t.status, t.cat] : [t.status, t.host, t.pathname]),
            E("bstXhrAgg", ["xhr", i, t, e]),
            p.store("xhr", i, t, e),
            d()) {
                if (!A(t))
                    return void R(t.hostname === x.info.errorBeacon ? "Ajax/Events/Excluded/Agent" : "Ajax/Events/Excluded/App");
                var a = this
                  , s = {
                    method: t.method,
                    status: t.status,
        ...
        function i(t) {
            ...
            0 === M.length)
                return null;
            for (var e = a(M, t.maxPayloadSize || U), n = [], r = 0; r < e.length; r++)
                n.push({
                    body: {
                        e: e[r]
                    }
                });
            return t.retry && (O = M.slice()),
            M = [],
            n
        }
        function a(t, e, n) {
        ...
        function s(t) {
            t.retry && O.length > 0 && d() && (M = M.concat(O),
            O = [])
        }
        function u() {
            l.runHarvest({
        ...
        function c(t, e) {
            e = e || t.length;
            for (var n = [], r = 0, o = t.length; r < o; r += e)
                n.push(new f(t.slice(r, r + e)));
            return n
        }
        function f(t) {
            this.addString = w(),
            ...
            for (var e = 0; e < this.events.length; e++) {
                ...
                r.unshift(y(i.length)),
                o += r.join(","),
                i && i.length > 0 && (o += ";" + i.join(";")),
                e + 1 < this.events.length && (o += ";"),
                this.payload += o
            }
            this.tooBig = function(t) {
                return t = t || U,
                2 * this.payload.length > t;
            }
        }
        function d() {
        ...
        var l, p = t(2), m = t(17), h = t(10), v = t(22), g = t(4).nullable, y = t(4).numeric, w = t(4).getAddStringContext, b = t(4).addCustomAttributes, x = t("loader"), T = t("ee"), E = t("handle"), S = t(37), j = t(9), k = t(34).setDenyList, A = t(34).shouldCollectEvent, C = t(25), R = t(41).recordSupportability, M = [], N = {}, O = [];
        if (x.features.xhr) {
            ...
            e.exports = o,
            e.exports.prepareHarvest = i,
            e.exports.getStoredEvents = r,
            e.exports.shouldCollectEvent = A,
            e.exports.setDenyList = k,
    ...
    40: [function(t, e, n) {
        function r() {
            var t = [];
            try {
                return o() && t.push(s.REACT),
                i() && t.push(s.ANGULARJS),
                a() && t.push(s.ANGULAR),
    ...
    41: [function(t, e, n) {
        function r(t, e) {
            ...
            return i("storeMetric", n, null, "api"),
            n
        }
        function o(t, e) {
            var n = [s, t, {
            ...
            return i("storeEventMetrics", n, null, "api"),
            n
        }
        var i = t("handle")
          , a = "sm"
